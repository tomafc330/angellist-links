...
//click on all the click_for_more first
	...
	function setLoading(show) {
		if (show) {
			$('body').prepend("<div id='highlight-loading' style='position: fixed; bottom: 0px; font-size: xx-large; width: 100%; text-align: center; background: yellow; opacity: 0.8; z-index: 10001'><b>Checking for connections...</b></div>")
		} else {
